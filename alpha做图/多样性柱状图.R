...
# 读取vegan表
alpha_div = read.table("D:/沙漠数据/alpha/16S.vegan.txt", header=T, row.names=1, sep="\t", comment.char="")
#读取元数据
...
ggsave(paste0("D:/沙漠数据/alpha做图/","16S.barplot_richness",".pdf"), p, width = 89, height = 59, units = "mm")
